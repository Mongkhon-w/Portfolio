...
const translations = {
  EN: {
    ...
    location: 'Thailand',
    source: 'Source code',
    description: 'Mongkol Wichayaphap - Network Engineer and Full-stack Developer. This website provides REST APIs using Node.js and JSON data structures, along with technical write-ups on Flutter.',
  ...
  TH: {
    ...
    location: 'ประเทศไทย',
    source: 'ซอร์สโค้ด',
    description: 'มงคล วิชัยภาพ - วิศวกรเครือข่ายและนักพัฒนา Full-stack เว็บไซต์นี้ให้บริการ REST APIs ที่เขียนด้วย Node.js และจัดการข้อมูลแบบ JSON พร้อมบทความด้าน Flutter',
